...
if __name__ == "__main__":
    ...
    spy_processed_data  = process_stock_data(spy_raw_data, 'SPY', False)
    spy_processed_log_data  = process_stock_data(spy_raw_data, 'SPY', True)
    print("\n" + "=" * 50 + "\n")

    # Plot Individual Statistical Plots
    plot_statistics(fred_processed_data_covid, 'Unemployment Rate with COVID', result_dir=RESULTS_DIR, color = UNRATE_DATASET_COLOR)
    print("\n" + "=" * 50 + "\n")

    plot_statistics(fred_processed_data, 'Unemployment Rate', result_dir=RESULTS_DIR, color = UNRATE_DATASET_COLOR)
    print("\n" + "=" * 50 + "\n")

    plot_statistics(nvidia_processed_data, 'NVIDIA Close Price', result_dir=RESULTS_DIR, color = NVIDIA_DATASET_COLOR)
    print("\n" + "=" * 50 + "\n")

    plot_statistics(nvidia_processed_log_data, 'NVIDIA Log Close Price', result_dir=RESULTS_DIR, color = NVIDIA_DATASET_COLOR)
    print("\n" + "=" * 50 + "\n")

    plot_statistics(spy_processed_data, 'SPY Log Close Price', result_dir=RESULTS_DIR, color = SPY_DATASET_COLOR)
    print("\n" + "=" * 50 + "\n")

    plot_statistics(spy_processed_log_data, 'SPY Log Close Price', result_dir=RESULTS_DIR, color = SPY_DATASET_COLOR)
    print("\n" + "=" * 50 + "\n")

    #Plot Correlation Analysis Plots
    plot_correlation_analysis(nvidia_processed_log_data, fred_processed_data, NVIDIA_DATASET_COLOR, UNRATE_DATASET_COLOR, 'NVIDIA Log Close Price', 'Unemployment Rate', result_dir=RESULTS_DIR)
    print("\n" + "=" * 50 + "\n")
    ...
    plot_correlation_analysis(nvidia_processed_log_data_pre_ai_boom, fred_processed_data_pre_ai_boom, NVIDIA_DATASET_COLOR, UNRATE_DATASET_COLOR, 'NVIDIA Log Close Price', 'Unemployment Rate', result_dir= RESULTS_DIR, ai_boom= 'Pre')
    plot_correlation_analysis(nvidia_processed_log_data_pre_ai_boom, spy_processed_log_data_pre_ai_boom, NVIDIA_DATASET_COLOR, SPY_DATASET_COLOR, 'NVIDIA Log Close Price', 'SPY Log Close Price', fred_processed_data_pre_ai_boom, UNRATE_DATASET_COLOR, 'Unemployment Rate', result_dir= RESULTS_DIR, ai_boom= 'Pre')
    ...
    plot_correlation_analysis(nvidia_processed_log_data_post_ai_boom, fred_processed_data_post_ai_boom, NVIDIA_DATASET_COLOR, UNRATE_DATASET_COLOR, 'NVIDIA Log Close Price', 'Unemployment Rate', result_dir= RESULTS_DIR, ai_boom= 'Post')
    plot_correlation_analysis(nvidia_processed_log_data_post_ai_boom, spy_processed_log_data_post_ai_boom, NVIDIA_DATASET_COLOR, SPY_DATASET_COLOR, 'NVIDIA Log Close Price', 'SPY Log Close Price', fred_processed_data_post_ai_boom, UNRATE_DATASET_COLOR, 'Unemployment Rate', result_dir= RESULTS_DIR, ai_boom= 'Post')
